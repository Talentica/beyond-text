...
public class TestCsvToParquet extends Configured implements Tool {
	...
	public static class ParquetMapper extends
		...
		public void map(LongWritable key, Text value, Context context)
			...
			SimpleGroupFactory sgf = new SimpleGroupFactory(
					MessageTypeParser.parseMessageType(schema1));
	...
	public int run(String[] args) throws Exception {
		...
		System.out.print("filename " + schemaPath + "absolutepath"
				+ filep.getAbsolutePath() + filep.getName());
